...
class FormGameLevel3(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background, imagen_background, color_border,active,config_json, nevel12):
        super().__init__(name,master_surface,x,y,w,h,color_background, imagen_background, color_border,active)
        self.levels = config_json
        self.player_1 = self.generate_player()
        self.music_path = r"effect_sound\\final.mp3"
        self.music_menu = r"effect_sound\\menu.mp3"
        self.tiempo_inicial = pygame.time.get_ticks()
        self.music = True
        self.cronometro = 60
        self.acumuladorNiveles = nevel12
        self.score_total = 0
        self.pausado = False
        self.font = pygame.font.SysFont("IMPACTO",50)
        # --- GUI WIDGET ---

        self.text_lvl = Widget(master=self,x=5,y=25,w=200,h=50,color_background=None,color_border=None,image_background="images\gui\set_gui_01\Data_Border\Buttons\Button_XL_04.png",text="NIVEL 3",font='opensans.ttf',font_size=40,font_color=C_WHITE)
        ...
        # --- GAME ELEMENTS ---
        self.static_background = Background(x=0,y=0,width=w,height=h,path="images\\final.png")
    ...
    def generate_enemies_distance(self):
        data_enemies = self.levels[2]["enemies_distance"]
        for enemy in data_enemies:
    ...
    def generate_fruit(self):
        data_fruit = self.levels[2]["fruit"]
    ...
    def generate_trampas(self):
        data_trampa = self.levels[2]["trampa"]
    ...
    def update(self, lista_eventos, keys, delta_ms, event, evento_1000ms):
        ...
        if self.player_1.score >= 700:
            self.score_total = self.acumuladorNiveles.score_total
